...
$(function(){
				...
				success :function(resultVo){
					if(resultVo.status==200 ){
						...
						if(resultList!=null && resultList.length>0) {
						    //已购买
							_this.getWXSendTimes();
							_this.getMaterialList(0,1);
							_this.handleWxItemEvent();
						}else{
							//没有购买

							location.href="/o2o/route/"+wxGLOBAL.shopSid+"/qrcode-open_pub_succeeds?access_token="+accessToken;
						}
	...
	$(".changeSj").on("click",function(){
		var url ="/o2o/route/"+ wxGLOBAL.shopSid+ "/tools-qrcode-qrcode_pay_focus?access_token=" + store.get("wx_access_token");

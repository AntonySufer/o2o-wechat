...
/* my local debug loggers */
/*var fs = require('fs');
var accessLogFile = fs.createWriteStream("access.log",{flags:"a"});
var errorLogFile = fs.createWriteStream("error.log",{flags:"a"});

app.use(express.logger({stream:accessLogFile})); // 开发环境
/!* 错误日志*!/
...
app.use("/o2o/bind",require('./routes/userRouters'));
app.use("/o2o",require('./routes/userRouters'));
